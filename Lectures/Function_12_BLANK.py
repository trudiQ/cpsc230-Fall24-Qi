...
1. Ask the user for their name, and print a welcome message to the user, e.g., "Welcome, [name]!"
    PARK 1: Define a function with one input parameter, name, that prints a welcome message using that parameter.
    PARK 2: Ask the user for their name, invoke (use) the function and input that name to the function as an argument.
Hint: 
